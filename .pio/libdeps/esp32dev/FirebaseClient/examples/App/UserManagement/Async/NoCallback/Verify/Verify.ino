 ...
 * ABOUT:
 *
 * The non-blocking (async) example to send the user verification email.
 *
 ...
 * 1.------------------------
 *
 * verify(<AsyncClient>, <FirebaseApp>, <user_auth_data>, <AsyncResult>);
 *
...
void setup()
{
    ...
    verify(aClient, app, getAuth(user.email("user@gmail.com").idToken(idtoken)), aResult_no_callback);
}
