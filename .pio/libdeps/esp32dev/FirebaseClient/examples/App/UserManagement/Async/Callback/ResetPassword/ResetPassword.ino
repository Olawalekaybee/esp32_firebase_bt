 ...
 * ABOUT:
 *
 * The non-blocking (async) example to reset the user password.
 *
...
void setup()
{
    ...
    resetPassword(aClient, app, getAuth(user.email("user@gmail.com").idToken(idtoken)), asyncCB, "resetPasswordTask");
}
