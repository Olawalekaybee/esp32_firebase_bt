 ...
 * ABOUT:
 *
 * The bare minimum non-blocking (async) example for Firebase user authentication using ID token.
 *
...
void setup()
{
    ...
    initializeApp(aClient, app, getAuth(id_token), aResult_no_callback);
}
