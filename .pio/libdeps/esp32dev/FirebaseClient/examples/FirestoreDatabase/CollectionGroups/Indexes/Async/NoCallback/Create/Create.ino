 ...
 * ABOUT:
 *
 * The non-blocking (async) example to create a Firestore composite index.
 *
 ...
 * 1.------------------------
 *
 * Firestore::CollectionGroups::Indexes::create(<AsyncClient>, <Firestore::Parent>, <collectionId>, <Index>, <AsyncResult>);
 *
