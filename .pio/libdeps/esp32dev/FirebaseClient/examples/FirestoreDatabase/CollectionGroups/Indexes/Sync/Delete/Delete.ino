 ...
 * ABOUT:
 *
 * The blocking (sync) example to delete a Firestore composite index.
 *
 ...
 * 1.------------------------
 *
 * String Firestore::CollectionGroups::Indexes::deleteIndex(<AsyncClient>, <Firestore::Parent>, <collectionId>, <indexId>);
 *
