 ...
 * ABOUT:
 *
 * The blocking (sync) example to create a Firestore composite index.
 *
 ...
 * 1.------------------------
 *
 * String Firestore::CollectionGroups::Indexes::create(<AsyncClient>, <Firestore::Parent>, <collectionId>, <Index>);
 *
