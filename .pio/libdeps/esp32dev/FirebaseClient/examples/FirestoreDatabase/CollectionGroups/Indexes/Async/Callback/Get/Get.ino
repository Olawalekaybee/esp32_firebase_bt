 ...
 * ABOUT:
 *
 * The non-blocking (async) example to get a Firestore composite index.
 *
 ...
 * 1.------------------------
 *
 * Firestore::CollectionGroups::Indexes::get(<AsyncClient>, <Firestore::Parent>, <collectionId>, <indexId>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        Serial.println("Getting a composite index... ");
        indexes.get(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), collectionId, indexId, asyncCB, "getTask");
    }
}
