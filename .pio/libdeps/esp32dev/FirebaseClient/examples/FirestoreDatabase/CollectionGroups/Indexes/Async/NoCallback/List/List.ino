 ...
 * ABOUT:
 *
 * The non-blocking (async) example to list the Firestore composite indexes.
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        indexes.list(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), collectionId, aResult_no_callback);
    }
