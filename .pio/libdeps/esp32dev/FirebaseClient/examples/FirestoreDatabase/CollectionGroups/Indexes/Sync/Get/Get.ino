 ...
 * ABOUT:
 *
 * The blocking (sync) example to get a Firestore composite index.
 *
 ...
 * 1.------------------------
 *
 * String Firestore::CollectionGroups::Indexes::get(<AsyncClient>, <Firestore::Parent>, <collectionId>, <indexId>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = indexes.get(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), collectionId, indexId);
