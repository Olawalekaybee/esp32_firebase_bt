 ...
 * ABOUT:
 *
 * The blocking (sync) example to list the Firestore indexes.
 *
 ...
 * 1.------------------------
 *
 * String Firestore::Databases::Indexes::list(<AsyncClient>, <Firestore::Parent>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = indexes.list(aClient, Firestore::Parent(FIREBASE_PROJECT_ID));
