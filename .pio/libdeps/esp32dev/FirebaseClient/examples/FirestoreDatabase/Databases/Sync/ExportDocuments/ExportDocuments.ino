 ...
 * ABOUT:
 *
 * The blocking (sync) example to export the Firestore documents.
 *
 ...
 * 1.------------------------
 *
 * String Firestore::Databases::exportDocuments(<AsyncClient>, <Firestore::Parent>, <collectionIds>, <bucketID>, <storagePath>);
 *
