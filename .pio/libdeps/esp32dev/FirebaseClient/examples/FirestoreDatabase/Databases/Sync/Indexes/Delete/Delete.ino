 ...
 * ABOUT:
 *
 * The blocking (sync) example to delete the specified Firestore index.
 *
 ...
 * 1.------------------------
 *
 * String Firestore::Databases::Indexes::deleteIndex(<AsyncClient>, <Firestore::Parent>, <indexId>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = indexes.deleteIndex(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), indexId);
