 ...
 * ABOUT:
 *
 * The blocking (sync) example to update the Firestore database.
 *
 ...
 *
 * The OAuth2.0 authentication or access token authorization is required for updating the Firestore database operation.
 *
 ...
 * 1.------------------------
 *
 * String Firestore::Databases::patch(<AsyncClient>, <Firestore::Parent>, <Database>, <UpdateMask>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = Databases.patch(aClient, Firestore::Parent(FIREBASE_PROJECT_ID, "myDb" /* database Id */), db, updateMask);
