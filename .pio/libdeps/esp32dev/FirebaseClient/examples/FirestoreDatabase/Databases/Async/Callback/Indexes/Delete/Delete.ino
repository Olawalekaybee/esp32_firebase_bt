 ...
 * ABOUT:
 *
 * The non-blocking (async) example to delete the specified Firestore index.
 *
 ...
 * 1.------------------------
 *
 * Firestore::Databases::Indexes::deleteIndex(<AsyncClient>, <Firestore::Parent>, <indexId>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        Serial.println("Deleting an index... ");
        indexes.deleteIndex(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), indexId, asyncCB, "deleteIndexTask");
    }
}
