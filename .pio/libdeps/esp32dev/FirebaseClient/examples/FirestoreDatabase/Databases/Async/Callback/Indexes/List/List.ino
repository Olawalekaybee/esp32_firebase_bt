 ...
 * ABOUT:
 *
 * The non-blocking (async) example to list the Firestore indexes.
 *
 ...
 * 1.------------------------
 *
 * Firestore::Databases::Indexes::list(<AsyncClient>, <Firestore::Parent>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        Serial.println("Listing the indexes.... ");
        indexes.list(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), asyncCB, "listTask");
    }
}
