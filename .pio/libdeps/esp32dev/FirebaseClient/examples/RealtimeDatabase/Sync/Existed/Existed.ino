 ...
 * ABOUT:
 *
 * The blocking (sync) example to check wether data existes in your database or not.
 *
 ...
 * 1.------------------------
 *
 * bool RealtimeDatabase::existed(<AsyncClient>, <path>);
 *
...
void setup()
{
    ...
    Serial.print("Checking data exists... ");
