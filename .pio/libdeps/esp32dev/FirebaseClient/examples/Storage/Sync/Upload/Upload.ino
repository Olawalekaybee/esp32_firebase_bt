 ...
 * ABOUT:
 *
 * The blocking (sync) example to upload object (file) to Storage bucket.
 *
 ...
 * 2.------------------------
 *
 * bool Storage::upload(<AsyncClient>, <FirebaseStorage::Parent>, <file_config_data>, <MIME>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        bool result = storage.upload(aClient, FirebaseStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), getFile(media_file), "video/mp4");
