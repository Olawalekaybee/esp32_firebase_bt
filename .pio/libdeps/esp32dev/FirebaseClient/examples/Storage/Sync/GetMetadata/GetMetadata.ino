 ...
 * 1.------------------------
 *
 * String Storage::getMetadata(<AsyncClient>, <FirebaseStorage::Parent>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = storage.getMetadata(aClient, FirebaseStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"));
