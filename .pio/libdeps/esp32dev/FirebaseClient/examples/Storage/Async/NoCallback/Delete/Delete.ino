 ...
 * ABOUT:
 *
 * The non-blocking (async) example to delete the object (file) in the Storage bucket.
 *
 ...
 * 1.------------------------
 *
 * Storage::deleteObject(<AsyncClient>, <FirebaseStorage::Parent>, <AsyncResult>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        storage.deleteObject(aClient, FirebaseStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), aResult_no_callback);
    }
