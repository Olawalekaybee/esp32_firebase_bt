 ...
 * 1.------------------------
 *
 * CloudStorage::list(<AsyncClient>, <GoogleCloudStorage::Parent>, <GoogleCloudStorage::ListOptions>, <AsyncResult>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cstorage.list(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID), options, aResult_no_callback);
    }
