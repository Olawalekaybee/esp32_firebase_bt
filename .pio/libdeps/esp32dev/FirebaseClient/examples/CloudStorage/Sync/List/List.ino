 ...
 * ABOUT:
 *
 * The blocking (sync) example to list all objects in Cloud Storage bucket.
 *
 ...
 * 1.------------------------
 *
 * String CloudStorage::list(<AsyncClient>, <GoogleCloudStorage::Parent>, <GoogleCloudStorage::ListOptions>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = cstorage.list(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID), options);
