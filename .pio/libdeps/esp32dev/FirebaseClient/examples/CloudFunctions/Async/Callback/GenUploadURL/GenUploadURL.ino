 ...
 * ABOUT:
 *
 * The non-blocking (async) example to get a signed URL for uploading a function source code (Cloud Functions).
 *
 ...
 * 1.------------------------
 *
 * CloudFunctions::generateUploadURL(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <GoogleCloudFunctions::UploadURLOptions>, <AsyncResultCallback>, <uid>);
 *
 ...
 * <functionId> - The function name or Id to get the download URL.
 * <GoogleCloudFunctions::UploadURLOptions> - The GoogleCloudFunctions::UploadURLOptions object that provides the kmsKeyName and environment options.
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        Serial.println("Getting a signed URL for uploading a function source code...");
        cfunctions.generateUploadURL(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, GoogleCloudFunctions::UploadURLOptions(), asyncCB, "genUploadURLTask");
    }
}
