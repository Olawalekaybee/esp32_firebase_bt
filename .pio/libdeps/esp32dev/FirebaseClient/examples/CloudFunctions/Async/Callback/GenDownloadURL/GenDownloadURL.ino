 ...
 * 1.------------------------
 *
 * CloudFunctions::generateDownloadURL(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.generateDownloadURL(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, asyncCB, "genDownloadURLTask");
    }
}
