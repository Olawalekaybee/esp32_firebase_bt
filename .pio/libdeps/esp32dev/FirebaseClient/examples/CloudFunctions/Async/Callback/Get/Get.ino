 ...
 * ABOUT:
 *
 * The non-blocking (async) example to get a function (Cloud Functions).
 *
 ...
 * 1.------------------------
 *
 * CloudFunctions::get(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <AsyncResultCallback>, <uid>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.get(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, asyncCB, "getTask");
    }
}
