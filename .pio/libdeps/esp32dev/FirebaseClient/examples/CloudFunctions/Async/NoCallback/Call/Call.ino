 ...
 * ABOUT:
 *
 * The non-blocking (async) example to call a function (Cloud Functions).
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.call(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, "test" /* data to pass to function */, aResult_no_callback);
    }
