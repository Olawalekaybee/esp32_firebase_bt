 ...
 * 1.------------------------
 *
 * CloudFunctions::getIamPolicy(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <GoogleCloudFunctions::GetPolicyOptions>, <AsyncResult>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.getIamPolicy(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, GoogleCloudFunctions::GetPolicyOptions(), aResult_no_callback);
    }
