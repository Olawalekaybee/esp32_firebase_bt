 ...
 * 1.------------------------
 *
 * CloudFunctions::deleteFunction(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <AsyncResult>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.deleteFunction(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "test" /* function name */, aResult_no_callback);
    }
