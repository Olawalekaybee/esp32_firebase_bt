 ...
 * 1.------------------------
 *
 * CloudFunctions::generateDownloadURL(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <AsyncResult>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        Serial.println("Getting a signed URL for downloading deployed function source code...");
        cfunctions.generateDownloadURL(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, aResult_no_callback);
    }
