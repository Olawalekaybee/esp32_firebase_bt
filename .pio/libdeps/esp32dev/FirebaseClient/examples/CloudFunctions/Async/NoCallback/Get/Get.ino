 ...
 * 1.------------------------
 *
 * CloudFunctions::get(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <AsyncResult>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.get(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, aResult_no_callback);
    }
