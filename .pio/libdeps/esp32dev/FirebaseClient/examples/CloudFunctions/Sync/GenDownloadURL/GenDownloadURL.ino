 ...
 * 1.------------------------
 *
 * String CloudFunctions::generateDownloadURL(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = cfunctions.generateDownloadURL(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */);
