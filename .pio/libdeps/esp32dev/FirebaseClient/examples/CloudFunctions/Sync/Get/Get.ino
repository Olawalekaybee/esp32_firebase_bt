 ...
 * ABOUT:
 *
 * The blocking (sync) example to get a function (Cloud Functions).
 *
 ...
 * 1.------------------------
 *
 * String CloudFunctions::get(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>);
 *
...
#include <Arduino.h>
#if defined(ESP32) || defined(ARDUINO_RASPBERRY_PI_PICO_W) || defined(ARDUINO_GIGA) || defined(ARDUINO_OPTA) || defined(ARDUINO_OPTA)
#include <WiFi.h>
...
#elif defined(ARDUINO_ARCH_SAMD) || defined(ARDUINO_UNOWIFIR4) || defined(ARDUINO_GIGA) || defined(ARDUINO_OPTA) || defined(ARDUINO_OPTA) || defined(ARDUINO_PORTENTA_C33) || defined(ARDUINO_NANO_RP2040_CONNECT)
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        Serial.println("Getting a function...");
        String payload = cfunctions.get(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */);
