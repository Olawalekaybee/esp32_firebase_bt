 ...
 * ABOUT:
 *
 * The blocking (sync) example to update the existing function (Cloud Functions).
 *
 ...
 * 1.------------------------
 *
 * String CloudFunctions::patch(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <GoogleCloudFunctions::Function>, <updateMask>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = cfunctions.patch(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "test" /* function name */, function, updateMask);
