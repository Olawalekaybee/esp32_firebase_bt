 ...
 * ABOUT:
 *
 * The blocking (sync) example to get a signed URL for uploading a function source code (Cloud Functions).
 *
 ...
 * 1.------------------------
 *
 * String CloudFunctions::generateUploadURL(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>, <GoogleCloudFunctions::UploadURLOptions>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = cfunctions.generateUploadURL(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "helloWorld" /* function name */, GoogleCloudFunctions::UploadURLOptions());
