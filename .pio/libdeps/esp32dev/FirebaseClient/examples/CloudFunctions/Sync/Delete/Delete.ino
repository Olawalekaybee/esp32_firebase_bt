 ...
 * ABOUT:
 *
 * The blocking (sync) example to delete a function (Cloud Functions).
 *
 ...
 * 1.------------------------
 *
 * String CloudFunctions::deleteFunction(<AsyncClient>, <GoogleCloudFunctions::Parent>, <functionId>);
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        String payload = cfunctions.deleteFunction(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "test" /* function name */);
